...
import { Home, ChevronRight, ArrowRight, Globe, Volume2, BookOpen, Calendar } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-background">
      <BreadcrumbSchema items={[
        ...
        { name: data.language, path: `/phrases/${data.slug}` },
      ]} />
      <WebPageSchema
        path={`/phrases/${data.slug}`}
        name={`Common ${data.language} Phrases — Essential ${data.language} for Beginners`}
        description={`Learn ${data.language} phrases with pronunciation. Greetings, travel, food, numbers, and emergency phrases in ${data.language}.`}
        type="ItemPage"
      />
      <Navbar />
