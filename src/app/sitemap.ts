...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${BASE_URL}/adjectives-for`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/nouns-for`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/homophones`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/types-of`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/parts-of`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/related-words`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
    {
      url: `${BASE_URL}/scrabble-word-finder`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.93,
    },
    {
      url: `${BASE_URL}/sounds-like`,
      lastModified: BUILD_DATE,
      changeFrequency: "weekly",
      priority: 0.92,
    },
