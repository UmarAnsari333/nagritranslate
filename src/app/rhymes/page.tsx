...
import { Music2, ArrowRight, ChevronRight, Home } from 'lucide-react'
import { Navbar } from '@/components/navbar'
import { Footer } from '@/components/footer'
import { RHYME_WORDS } from '@/data/rhyme-words'
import { BreadcrumbSchema } from '@/components/breadcrumb-schema'
import { WebPageSchema } from '@/components/webpage-schema'
import { RhymesSearch } from '@/components/rhymes/rhymes-search'

export const metadata: Metadata = {
  title: 'Rhyming Dictionary — Find Rhymes for Any Word',
  description:
    'Free rhyming dictionary. Find perfect & near rhymes for 900+ words — for poetry, songs, rap lyrics, and creative writing.',
  keywords: [
    'rhyming words',
    'rhyme dictionary',
    'find rhymes',
  ...
  alternates: { canonical: 'https://nagritranslate.com/rhymes' },
  openGraph: {
    title: 'Rhyming Dictionary — Find Rhymes for Any Word',
    description: 'Free rhyming dictionary. Find perfect & near rhymes for 900+ English words.',
    type: 'website',
  },
}

// Group words by first letter
const grouped = RHYME_WORDS.reduce<Record<string, string[]>>((acc, word) => {
...
const FEATURED = [
  'love', 'moon', 'star', 'dream', 'heart', 'light',
  'time', 'fire', 'rain', 'night', 'song', 'spring',
]
...
export default function RhymesPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <WebPageSchema
        path="/rhymes"
        name="Rhymes Dictionary — Find Rhyming Words for Any Word"
        description="Free rhyming dictionary. Find perfect and near rhymes for 800+ English words."
        type="CollectionPage"
      />
      <Navbar />
      ...
      <section className="max-w-5xl mx-auto px-4 pt-8 pb-6 md:pt-14">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span className="text-foreground font-medium">Rhymes</span>
        </nav>
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3">Rhymes Dictionary</h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
            Find perfect rhymes and near rhymes for any English word. Great for poetry, songs, rap lyrics, and creative writing.
          </p>
          <RhymesSearch />
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <div className="p-6 md:p-8 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border text-center">
          ...
          <p className="text-muted-foreground text-sm mb-5">
            Not seeing your word in the list? Search it above — rhymes work for any English word.
          </p>
          <RhymesSearch />
        </div>
      </section>
