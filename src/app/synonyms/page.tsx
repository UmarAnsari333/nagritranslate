...
import { SynonymsSearch } from '@/components/synonyms/synonyms-search'

export const metadata: Metadata = {
  title: 'Synonyms Dictionary — Another Word for Any Word',
  description:
    'Free synonyms dictionary. Find synonyms, similar words & antonyms for 3,000+ English words. Great for writing, essays & vocabulary building.',
  keywords: [
    'synonyms',
    'synonym finder',
    'another word for',
  ...
  alternates: { canonical: 'https://nagritranslate.com/synonyms' },
  openGraph: {
    title: 'Synonyms Dictionary — Another Word for Any Word',
    description: 'Free synonyms dictionary. Find synonyms & antonyms for 3,000+ English words.',
    type: 'website',
  },
}
...
export default function SynonymsPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <WebPageSchema
        path="/synonyms"
        name="Synonyms Dictionary — Another Word for Any Word"
        description="Free synonyms dictionary. Find synonyms & antonyms for 3,000+ English words."
        type="CollectionPage"
      />
      <Navbar />
      ...
      <section className="max-w-5xl mx-auto px-4 pt-8 pb-6 md:pt-14">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span className="text-foreground font-medium">Synonyms</span>
        </nav>
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3">Synonyms Dictionary</h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
            Find synonyms, similar words, and antonyms for any English word. Perfect for writing, essays, and expanding your vocabulary.
          </p>
          <SynonymsSearch />
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-12">
        <div className="p-6 md:p-8 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl border text-center">
          ...
          <p className="text-muted-foreground text-sm mb-5">
            Not seeing your word? Search above — synonyms work for any English word.
          </p>
          <SynonymsSearch />
        </div>
      </section>
